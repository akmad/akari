...
`akari sync` discovers the session records Claude Code, Codex, pi, OMP, Cursor,
Grok, and OpenCode leave locally, resolves each to its git project, and streams the new bytes to
